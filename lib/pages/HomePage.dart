            ...
            builder: (context, snapshot){
              if(snapshot.connectionState == ConnectionState.active){
                if(snapshot.hasData){
                          ...
                          if(userData.connectionState == ConnectionState.done){
                            if(userData.data !=null){
                              ...
                              return ListTile(
                                ...
                                subtitle: (chatRoomModel.lastMessage.toString() !="")? Text(chatRoomModel.lastMessage.toString()) : Text("Say Hi to your new friend :D", style: TextStyle(
                  ...
                  return Center(
                    child: Text("Welcome! Let's search a Friend and Start Conversation"),
                  );
                }
              }
              else{
